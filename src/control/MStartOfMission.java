...
public class MStartOfMission extends Machine {
	
private String name = "MStartOfMission";
	...
	public MStartOfMission(Machine parent, State entry, ExternalChannel p1, ExternalChannel p2) {
		super(parent, entry);
		PchFrom = p1;
		PchTo = p2;
	}
